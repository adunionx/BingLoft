    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-lg-offset-1 col-md-4 col-md-offset-1 col-sm-5 col-xs-12">
        <div class="list-group benefits wow fadeInRight">
          ...
          <p class="light"><i class="fa fa-check-circle"></i>Management Control Panel</p>
        </div>
      </div>
    </div>
    <div class="row"> 
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
        <h3 class="wow fadeInLeft"> <i class="fa fa-arrow-circle-right"></i>Powered by cPanel</h3>
        <p class="light wow fadeInLeft">cPanel is a backend administration interface that makes it easy for you to manage your website</p>
        <div class="row">
      ...
      <div class="col-lg-4 col-lg-offset-1 col-md-5 col-sm-12 col-xs-12 wow bounceIn"> <img src="{$WEB_ROOT}/templates/{$template}/html/img/hostingplans/features/cpanel.png" class="img-responsive" /> </div>
    </div>
  </div>
</section>
